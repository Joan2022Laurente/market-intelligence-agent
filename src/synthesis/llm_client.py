...
class LocalLLMClient:
    ...
    async def generate_synthesis(self, context_data: Dict[str, Any]) -> str:
        ...
        system_prompt = (
            ...
            "Revisa la clave 'predicciones_activas' del JSON.\n"
            "- Si está vacía o hay un error de conexión, escribe: 'No se encontraron apuestas activas o falta autorización en la API Key (Error -1002). Asegúrate de tener tu IP en lista blanca y el SAS habilitado.'\n"
            "- Si hay posiciones activas, listalas con su mercado, monto apostado y estado actual. Aconséjale sobre si mantener o cerrar basándote en las noticias del día.\n\n"
            "### 📰 Impacto de Noticias\n"
