...
class LocalLLMClient:
    ...
    async def generate_synthesis(self, context_data: Dict[str, Any]) -> str:
        ...
        system_prompt = (
            ...
            "Indica cuánto ha cambiado el valor del SOL en Earn hoy respecto al cambio_pct_24h.\n\n"
            ...
            "- [emoji] **[recomendacion]**: [justificación en 1 frase, mencionando impacto en el SOL de Joan si aplica]\n\n"
