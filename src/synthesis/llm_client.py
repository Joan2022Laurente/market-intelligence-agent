...
class LocalLLMClient:
    ...
    async def generate_synthesis(self, context_data: Dict[str, Any]) -> str:
        ...
        system_prompt = (
            ...
            "Luego, usando la variable 'tipo_cambio_pen', muestra el valor total en Soles (PEN) (ej. 'Total: $8.10 USD (≈ S/ 30.50 PEN)'). "
            ...
            "### 🔮 Predicciones y Apuestas Activas (Binance Prediction Market)\n"
            "Revisa las claves 'predicciones_activas' y 'historial_predicciones' del JSON.\n"
            "- Si 'predicciones_activas' tiene posiciones, listalas con su mercado, monto apostado y estado actual. Aconséjale sobre si mantener o cerrar basándote en las noticias del día.\n"
            "- En la subsección 'Historial y Rendimiento', revisa 'historial_predicciones'. Si hay apuestas cerradas, resume su PNL (Ganancias/Pérdidas totales) en esas apuestas y analiza brevemente qué tipo de predicciones le han funcionado mejor. Si está vacío, omite esta subsección.\n"
            "- Si todo está vacío, simplemente escribe: 'No se encontraron apuestas activas ni historial en el mercado de predicciones.'\n\n"
            "### 📰 Impacto de Noticias\n"
